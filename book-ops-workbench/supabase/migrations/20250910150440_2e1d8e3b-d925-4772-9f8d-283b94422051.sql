-- Fix constraint to allow LOAD_BALANCE
ALTER TABLE public.assignment_rules DROP CONSTRAINT IF EXISTS assignment_rules_rule_type_check;
ALTER TABLE public.assignment_rules ADD CONSTRAINT assignment_rules_rule_type_check CHECK (rule_type IN ('GEO_FIRST', 'CONTINUITY', 'TIER_BALANCE', 'ROUND_ROBIN', 'CUSTOM', 'LOAD_BALANCE'));
